...
@section('head')
    ...
    <style>
        ...
        .case-monitor-table th:nth-child(2),
        .case-monitor-table td:nth-child(2) { width: 25%; }
        .case-monitor-table th:nth-child(3),
        .case-monitor-table td:nth-child(3) { width: 28%; }
        .case-monitor-table th:nth-child(4),
        .case-monitor-table td:nth-child(4) { width: 17%; }
        .case-monitor-table th:nth-child(5),
        .case-monitor-table td:nth-child(5) { width: 7%; }
        .case-monitor-table th:nth-child(6),
        .case-monitor-table td:nth-child(6) { width: 23%; }
        ...
        .case-monitor-status--waiting {
            background: #fff7dd !important;
            border-color: #f5c451 !important;
            color: #9a6400 !important;
        }
        .case-monitor-status--active {
            background: #e8f1ff !important;
            border-color: #a8c7ff !important;
            color: #1e5ebf !important;
        }
        .case-monitor-status--assigned {
            background: #fff0df !important;
            border-color: #f5bb77 !important;
            color: #a45108 !important;
        }
        .case-monitor-status--completed {
            background: #e5f8ec !important;
            border-color: #94d9aa !important;
            color: #177a3b !important;
        }
        .case-monitor-status--neutral {
        ...
        @media (max-width: 1199px) {
            .case-monitor-table th:nth-child(2),
            .case-monitor-table td:nth-child(2) {
                display: none;
            }
            .case-monitor-table th:nth-child(3),
            .case-monitor-table td:nth-child(3) { width: 36%; }
            .case-monitor-table th:nth-child(4),
            .case-monitor-table td:nth-child(4) { width: 21%; }
            .case-monitor-table th:nth-child(5),
            .case-monitor-table td:nth-child(5) { width: 8%; }
            .case-monitor-table th:nth-child(6),
            .case-monitor-table td:nth-child(6) { width: 35%; }
            .case-monitor-card .solent-case-status-badge {
                                        ...
                                        <td class="solent-case-status-column">
                                            ...
                                            @if(str_contains($status, "In-Progress") || str_contains($status, "Active") )
                                                @php
                                                    ...
                                                    $employee= null;
                                                @endphp
                                            <span class="badge solent-case-status-badge case-monitor-status--active">
                                                               <span> {{$employee != null ? $employee->name_initials : "N/A"}}
                                                               </span></span>
                                            @elseif(str_contains($status, "Assigned"))
                                                <span class="badge solent-case-status-badge case-monitor-status--assigned">
                                                        {{ $statusLabel }}</span>

                                            @elseif(str_contains($status, "Waiting"))
                                            <span class="badge solent-case-status-badge case-monitor-status--waiting">
                                                        {{ $statusLabel }}</span>
                                            @elseif($status === 'DC' || $status === 'Completed')
                                            <span class="badge solent-case-status-badge case-monitor-status--completed">
                                                        {{ $statusLabel }}</span>
                                            @else
                                            <span class="badge solent-case-status-badge case-monitor-status--neutral">
                                                             {{ $statusLabel }} </span>
