...
<head>
    ...
    @php($pageTitle = $pageSlug ?? ($brandingName ?? config('site_vars.projectNameShort')))
...
<body {{-- onload="myFunction()" --}} class="white-content{{ $class ?? '' }}{{ ($pageSlug ?? null) === 'Dashboard' ? ' solent-dashboard-page' : '' }}">
