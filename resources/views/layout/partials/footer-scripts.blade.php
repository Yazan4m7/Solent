...
<!-- DataTables - Load main library first, then extensions -->
<script src="https://cdn.datatables.net/1.11.3/js/jquery.dataTables.min.js"></script>
<script>
    // Ensure DataTables is loaded before loading responsive extension
    if (typeof $.fn.DataTable !== 'undefined') {
        console.log('DataTables main library loaded successfully');
    } else {
        console.error('DataTables main library failed to load');
    }
</script>
...
//        }).trigger("change")
    ...
    // DataTables initialization with better error handling
