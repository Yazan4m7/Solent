    ...
    <div class="invoice-box">
        ...
        <section class="meta-info">
            <div class="doctor-field">
                الدكتور <span class="dotted-line">{{ $client->name }}</span> المحترم
            </div>
            ...
            <table>
                ...
                <tfoot>
                    @php
                        ...
                        $balanceAfterCase = $clientBalance;
                    @endphp
                    ...
                    <tr>
                        <td style="text-align: center; padding: 8px; font-weight: bold;">
                            <span id="netTotal" class="editable-value">{{ number_format($client->balance, 2) }}</span><span class="edit-icon">✏️</span>
                        </td>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const initialBalance = {{ $clientBalance }};
                ...
                if (paymentInput) {
                    paymentInput.addEventListener('input', function() {
                        ...
                        document.getElementById('balanceAfterPayment').textContent = newBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });

                        // Update net total
                        document.getElementById('netTotal').textContent = newBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                    });
                }
            });
        </script>
