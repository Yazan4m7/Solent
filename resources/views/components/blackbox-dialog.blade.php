...
<div class="blackbox-modal" id="blackboxModal" tabindex="-1" role="dialog">
    <div class="blackbox-dialog">
        <button class="blackbox-close-button" onclick="closeModal()">X</button>
