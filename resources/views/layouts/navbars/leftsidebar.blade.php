<div class="sidebar">
    ...
    @php
        ...
        $sidebarBrandMarkFallback = asset(config('branding.defaults.sidebar_mark_path'));
    ...
    <div class="korvion-sidebar-brand">
        <a class="korvion-sidebar-logo" href="{{ $isPlatformAdminPage ? route('system.tenants.index') : route('home') }}"
            ...
            @else
                <img class="korvion-sidebar-logo-full" src="{{ $sidebarBrandMark }}" alt="{{ $sidebarBrandName }} sidebar logo" onerror="this.onerror=null;this.src='{{ $sidebarBrandMarkFallback }}';">
            @endif
        </a>
    ...
    <div class="sidebar-wrapper">
        @if ($isPlatformAdminPage)
            <ul class="nav solent-sidebar-nav">
                ...
                <li class="{{ str_starts_with((string) $currentRoute, 'system.tenants.') ? 'active' : '' }}">
                ...
                <li class="{{ str_starts_with((string) $currentRoute, 'system.databases.') ? 'active' : '' }}">
                    <a href="{{ route('system.databases.index') }}">
                        <span class="solent-sidebar-icon-shell">@include('layouts.navbars.partials.sidebar-icon', ['name' => 'database'])</span>
                        <span class="solent-sidebar-link-copy"><span>Databases</span><small>Storage and table activity</small></span>
                    </a>
                </li>
            </ul>
        @else
