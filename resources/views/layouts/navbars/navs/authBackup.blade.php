<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
    <div class="container-fluid">
        <div class="navbar-wrapper d-none" style="display: flex !important; flex-grow: 4">
            ...
            <div class="navbar-brand" href="#"><img src="{{ asset($brandingLogoPath) }}"  width=190 alt="{{ $brandingName ?? 'Brand' }}"/> </div>
        </div>
        <div style = "flex-grow: 5"> {{$pageSlug ?? ($brandingName ?? 'Korvion')}} </div>
