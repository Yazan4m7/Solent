    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">   <div class="navbar-wrapper d-none" style="display: flex !important; flex-grow: 4">
                    ...
                    <div class="navbar-brand" href="#"><img src="{{ asset($brandingSidebarMarkPath ?? config('branding.defaults.sidebar_mark_path')) }}" style="max-height: 60px; width: auto;" alt="{{ $brandingName ?? 'Brand' }}"/> </div>
                </div></div>
