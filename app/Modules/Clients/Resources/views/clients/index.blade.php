                ...
                <div class="">
                    <form class="kt-form" method="GET" action="{{ route('clients-index') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 my-1" style="text-align: right">
                                @if (($permissions && $permissions->contains('permission_id', 107)) || Auth()->user()->is_admin)
                            ...
                            <div class="col-md-3 col-sm-6 my-1">
                                @if (($permissions && $permissions->contains('permission_id', 107)) || Auth()->user()->is_admin)
                                    <h4 style="margin: 0">
                                        ...
                                        <span style="font-weight: bold; font-size: 16px;">{{ $currencyLabel }}</span>
                                    </h4>
                                @endif
                            </div>
                        </div>
                                                    ...
                                                    <div class="row"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            @if (Auth()->user()->is_admin)
                                                                ...
                                                                <div class="col-6 padding5px">
                                                                    <a href="{{ route('toggle-client-active', $client->id) }}"
                                                                        onclick="return confirm('Are you sure you want to {{ $client->active ? 'disable' : 'enable' }} this doctor?');">
                                                                        <button type="button"
                                                                            class="btn {{ $client->active ? 'btn-warning' : 'btn-success' }}">
