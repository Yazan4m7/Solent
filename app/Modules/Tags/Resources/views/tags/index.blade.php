    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <div class="m-b-30">
                <div class="">
                    <div class="row">
                        <div class="col-12 solent-config-create-row">  <a href="{{route('new-tag-view')}}" ><button type="button"  class="btn btn-secondary"><i class="fa fa-plus-circle"></i> NEW TAG</button></a>   </div>
                    </div>
